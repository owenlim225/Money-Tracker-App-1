...
class LoadingScreen(tk.Tk):
    def __init__(self):
        ...
        # # Center LoadingScreen self
        # self.update_idletasks()
        # screen_width = self.winfo_screenwidth()
        # screen_height = self.winfo_screenheight()
        # self_width = self.winfo_reqwidth()
        # self_height = self.winfo_reqheight()
        # x = (screen_width - self_width) // 2
        # y = (screen_height - self_height) // 2
...
Christian Jude N. Villaber
  ...
  Sherwin P. Limosnero
    ...
    # def remove_data_from_db(self):    #~~ Note: Nag fefreeze kapag pinindot edit button with this activated.
    #     remove_data_from_db(self)     # ~~ Sherwin: "Tangina?"
